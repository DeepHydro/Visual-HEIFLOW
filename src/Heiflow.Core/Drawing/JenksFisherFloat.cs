...
namespace Heiflow.Core.Drawing
{
    ...
    public class JenksFisherFloat
    {
        ...
        private JenksFisherFloat(List<ValueCountTuple> tuples, int numBreaks)
        {
        ...
        private static List<float> ClassifyByJenksFisher(int numBreaks, List<ValueCountTuple> tuples)
        {
            ...
            var classificator = new JenksFisherFloat(tuples, numBreaks);
            if (numBreaks > 1)
            {
