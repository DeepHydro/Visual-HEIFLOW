...
Namespace Manhattan
    ...
    Public Class manhattanPolygon
        ...
        Public Shared Function box(ByVal x As Double, ByVal y As Double, ByVal width As Integer) As manhattanPolygon
            ...
            perimeter.Add(New manhattanCustomLink(x, y, manhattanCustomLink.manhattanDirection.up))
            For i As Integer = 0 To width - 1
                perimeter.Add(New manhattanCustomLink(x + i, y + 1, manhattanCustomLink.manhattanDirection.right))
            Next i
            perimeter.Add(New manhattanCustomLink(x + width, y, manhattanCustomLink.manhattanDirection.down))
            For i As Integer = width - 1 To 0 Step -1
                perimeter.Add(New manhattanCustomLink(x + i, y, manhattanCustomLink.manhattanDirection.left))
            Next i
        ...
        Public Shared Function canMerge(ByVal p1 As manhattanPolygon, <System.Runtime.InteropServices.Out()> ByRef i1 As Integer, ByVal p2 As manhattanPolygon, <System.Runtime.InteropServices.Out()> ByRef i2 As Integer) As Boolean
            ...
            For i1 = 0 To l1.Count - 1
                ...
                If (dir = manhattanCustomLink.manhattanDirection.left) OrElse (dir = manhattanCustomLink.manhattanDirection.right) Then ' OrElse (dir = Direction.up) OrElse (dir = Direction.down)
        ...
        Public Shared Function hasHole(ByVal l As List(Of manhattanCustomLink), <System.Runtime.InteropServices.Out()> ByRef first As Integer, <System.Runtime.InteropServices.Out()> ByRef last As Integer) As Boolean
            For first = 0 To l.Count - 2
                ...
                Dim dir As manhattanCustomLink.manhattanDirection = link.dir
                ' only horizontal links need be considered
                If (dir = manhattanCustomLink.manhattanDirection.left) OrElse (dir = manhattanCustomLink.manhattanDirection.right) Then
