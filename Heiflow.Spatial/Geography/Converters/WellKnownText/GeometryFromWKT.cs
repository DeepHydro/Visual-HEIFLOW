...
{
    /// <summary>
    ///  Converts a Well-known Text representation to a <see cref="Heiflow.Spatial.Geography.Geometry"/> instance.
    /// </summary>
    /// <remarks>
    ...
    {
        /// <summary>
        /// Converts a Well-known text representation to a <see cref="Heiflow.Spatial.Geography.Geometry"/>.
        /// </summary>
        /// <param name="wellKnownText">A <see cref="Heiflow.Spatial.Geography.Geometry"/> tagged text string ( see the OpenGIS Simple Features Specification.</param>
        /// <returns>Returns a <see cref="Heiflow.Spatial.Geography.Geometry"/> specified by wellKnownText.  Throws an exception if there is a parsing problem.</returns>
        ...
        /// <returns>Returns a <see cref="Heiflow.Spatial.Geography.Geometry"/> read from StreamReader. 
