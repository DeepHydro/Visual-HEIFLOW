...
{
    /// <summary>
    ///  Converts Well-known Binary representations to a <see cref="Heiflow.Spatial.Geography.Geometry"/> instance.
    /// </summary>
    /// <remarks>
    ...
    {
        /// <summary>
        /// Creates a <see cref="Heiflow.Spatial.Geography.Geometry"/> from the supplied byte[] containing the Well-known Binary representation.
        /// </summary>
        /// <param name="bytes">byte[] containing the Well-known Binary representation.</param>
        /// <returns>A <see cref="Heiflow.Spatial.Geography.Geometry"/> bases on the supplied Well-known Binary representation.</returns>
        ...
        /// <summary>
        /// Creates a <see cref="Heiflow.Spatial.Geography.Geometry"/> based on the Well-known binary representation.
        /// </summary>
        ...
        /// <returns>A <see cref="Heiflow.Spatial.Geography.Geometry"/> based on the Well-known binary representation.</returns>
