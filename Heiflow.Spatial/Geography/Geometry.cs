...
using System;
using Heiflow.Spatial.Converters.WellKnownText;
using Heiflow.Spatial.Converters.WellKnownBinary;
...
namespace Heiflow.Spatial.Geography
{
    ...
    public abstract class Geometry : IGeometry, IEquatable<Geometry>
    {
        ...
        /// <summary>
        /// Returns 'true' if this Geometry is 憇patially disjoint?from another <see cref="Geometry"/>.
        /// </summary>
        ...
        /// <summary>
        /// Returns 'true' if this <see cref="Geometry"/> 憇patially intersects?another <see cref="Geometry"/>.
        /// </summary>
        ...
        /// <summary>
        /// Returns 'true' if this <see cref="Geometry"/> 憇patially touches?another <see cref="Geometry"/>.
        /// </summary>
        ...
        /// <summary>
        /// Returns 'true' if this <see cref="Geometry"/> 憇patially crosses?another <see cref="Geometry"/>.
        /// </summary>
        ...
        /// <summary>
        /// Returns 'true' if this <see cref="Geometry"/> is 憇patially within?another <see cref="Geometry"/>.
        /// </summary>
        ...
        /// <summary>
        /// Returns 'true' if this <see cref="Geometry"/> 憇patially contains?another <see cref="Geometry"/>.
        /// </summary>
