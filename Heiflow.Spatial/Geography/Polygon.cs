...
namespace Heiflow.Spatial.Geography
{
    ...
    public class Polygon : Surface
    {
        ...
        public static Polygon Creates(string[] pointsStr, char splitor)
        {
            if (pointsStr != null)
            {
                ...
                foreach (string pstr in pointsStr)
                {
                    ...
                    lr.Vertices.Add(new Point(double.Parse(point[0]), double.Parse(point[1])));
                }
        ...
        public Point[] WorldToView(IViewTransform transform)
        {
            ...
            for (int k = 0; k < _InteriorRings.Count; k++)
            {
                ...
                //		v[j + i] = HUST.WREIS.Utilities.Transform.WorldtoMap(_InteriorRings[k].Vertices[_InteriorRings[k].Vertices.Count - i - 1], map);
                //}
         ...
         public int NumPoints
        {
            get
            {
                int num = _ExteriorRing.Vertices.Count;
                return num;
            }
        }
    }
