...
#define SQLite
namespace Heiflow.Spatial.CacheProviders
{
#if SQLite
   ...
   public class SQLitePureImageCache : PureImageCache
   {
      ...
      static System.Reflection.Assembly CurrentDomain_AssemblyResolve(object sender, ResolveEventArgs args)
      {
         ...
         {
            string rootDir = System.Environment.GetFolderPath(System.Environment.SpecialFolder.LocalApplicationData) + Path.DirectorySeparatorChar + "Heiflow.Spatial" + Path.DirectorySeparatorChar;
...
#else
                           cmd.CommandText = Heiflow.Spatial.WindowsMobile.Properties.Resources.CreateTileDb;
#endif
                           cmd.ExecuteNonQuery();
                        }
                        tr.Commit();
      ...
      MemoryStream PureImageCache.GetImageMemoryStream(int type, GPoint pos, int zoom)
      {
      ...
      public bool Exists(int type, GPoint pos, int zoom)
      {
          bool existed = false;
          using (SQLiteConnection cn = new SQLiteConnection())
          {
