...
namespace DotSpatial.Plugins.Taudem
{
    ...
    public class Hydrology
    {
        ...
        */
        ...
        {
            if (sf.DataTable.Columns.Contains(fieldname))
            {
            ...
            {
                int index = 0;
                for (int i = 0; i < sf.DataTable.Columns.Count; i++)
                {
                    if (sf.DataTable.Columns[i].ColumnName == fieldname)
                    {
                        index = i;
                        break;
                    }
        ...
        public static bool BuildJoinedBasins(string subBasinShapePath, string outletsShapePath, string joinBasinShapeResultPath, IProgressHandler callback)
        {
            ...
            if (outletsShapePath != string.Empty && outletsShapePath != null)
            {
